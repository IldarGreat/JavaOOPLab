...
public class StrictTabulatedFunctionTest {
    ...
    private static final StrictTabulatedFunction unmodifiableInStrictObject = new StrictTabulatedFunction(new UnmodifiableTabulatedFunction(arrayTabulatedObject));
    private static final UnmodifiableTabulatedFunction strictInUnmodifiableObject = new UnmodifiableTabulatedFunction(new StrictTabulatedFunction(arrayTabulatedObject));

    @Test
    public static void testGetCount() {
        Assert.assertEquals(strictArrayTabulated.getCount(), 4);
        Assert.assertEquals(strictLinkedListTabulated.getCount(), 7);
        Assert.assertEquals(unmodifiableInStrictObject.getCount(), 4);
        Assert.assertEquals(strictInUnmodifiableObject.getCount(), 4);
    }
    ...
    public static void testGetX() {
        ...
        Assert.assertEquals(unmodifiableInStrictObject.getX(0), 3.4);
        Assert.assertEquals(strictInUnmodifiableObject.getX(0), 3.4);
    }
    ...
    public static void testGetY() {
        ...
        Assert.assertEquals(unmodifiableInStrictObject.getY(0), -2.4);
        Assert.assertEquals(strictInUnmodifiableObject.getY(0), -2.4);
    }

    @Test
    public static void testLeftBound() {
        Assert.assertEquals(strictArrayTabulated.leftBound(), 3.4);
        Assert.assertEquals(strictLinkedListTabulated.leftBound(), 1.1);
        Assert.assertEquals(unmodifiableInStrictObject.leftBound(), 3.4);
        Assert.assertEquals(strictInUnmodifiableObject.leftBound(), 3.4);
    }

    @Test
    public static void testRightBound() {
        Assert.assertEquals(strictArrayTabulated.rightBound(), 7.1);
        Assert.assertEquals(strictLinkedListTabulated.rightBound(), 7.7);
        Assert.assertEquals(unmodifiableInStrictObject.rightBound(), 7.1);
        Assert.assertEquals(strictInUnmodifiableObject.rightBound(), 7.1);
    }
    ...
    public static void testIndexOfX() {
        ...
        Assert.assertEquals(unmodifiableInStrictObject.indexOfX(3.4), 0);
        Assert.assertEquals(strictInUnmodifiableObject.indexOfX(3.4), 0);
    }
    ...
    public static void testIndexOfY() {
        ...
        Assert.assertEquals(unmodifiableInStrictObject.indexOfY(-2.4), 0);
        Assert.assertEquals(strictInUnmodifiableObject.indexOfY(-2.4), 0);
    }
    ...
    public static void testApply() {
        ...
        Assert.assertThrows(UnsupportedOperationException.class, () -> unmodifiableInStrictObject.apply(7.4));
        Assert.assertThrows(UnsupportedOperationException.class, () -> strictInUnmodifiableObject.apply(7.4));
    }

    @Test
    public static void testSetY() {
        Assert.assertThrows(UnsupportedOperationException.class, () -> unmodifiableInStrictObject.setY(3, 2));
        Assert.assertThrows(UnsupportedOperationException.class, () -> strictInUnmodifiableObject.setY(2, 2));
    }
