...
import ru.ssau.tk.IldarValeria.LabSgau.functions.LinkedListTabulatedFunction;
...
public class TabulatedFunctionFileOutputStream {
    ...
    public static void main(String[] args) {
        try {
            BufferedOutputStream bufferedArray = new BufferedOutputStream(new FileOutputStream("output/array function.bin"));
            BufferedOutputStream bufferedList = new BufferedOutputStream(new FileOutputStream("output/linked list function.bin"));
