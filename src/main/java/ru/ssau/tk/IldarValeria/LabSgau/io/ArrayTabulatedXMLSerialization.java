...
public class ArrayTabulatedXMLSerialization {
    ...
    public static void main(String[] args) {
        try {
            BufferedWriter arrayWriter = new BufferedWriter(new FileWriter("output/arrayXML function.xml"));
            ...
            BufferedReader bufferedReader = new BufferedReader(new FileReader("output/arrayXML function.xml"));
